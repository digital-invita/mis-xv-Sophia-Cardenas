    ...
    const INVITATION_CONFIG =
{
  ...
  "theme": {
    ...
    "timelineTimeColor": "#fff4cf",
    "timelineTitleColor": "#ffffff",
    "timelineDescColor": "#f6d8d0",
  ...
  "brand": {
    ...
    function applySectionStyles() {
      ...
      Object.entries(sectionMap).forEach(([key, element]) => {
        ...
        element.style.setProperty("--location-time-color", titleColor);
        element.style.setProperty("--location-place-color", textColor);
        element.style.setProperty("--timeline-time-color", titleColor);
        element.style.setProperty("--timeline-title-color", titleColor);
